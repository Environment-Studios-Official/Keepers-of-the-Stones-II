...
public class WheelAbilitiesAnimalsScreen extends AbstractContainerScreen<WheelAbilitiesAnimalsMenu> {
	...
	public void init() {
		super.init();
		button_1 = Button.builder(Component.translatable("gui.power.wheel_abilities_animals.button_1"), e -> {
			if (true) {
		...
		button_2 = Button.builder(Component.translatable("gui.power.wheel_abilities_animals.button_2"), e -> {
			if (true) {
		...
		button_3 = Button.builder(Component.translatable("gui.power.wheel_abilities_animals.button_3"), e -> {
			if (true) {
