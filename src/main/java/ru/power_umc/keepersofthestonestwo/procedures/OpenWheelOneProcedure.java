...
public class OpenWheelOneProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		} else if (entity.getData(PowerModVariables.PLAYER_VARIABLES).element_id_fist == 2) {
			if (entity instanceof ServerPlayer _ent) {
				BlockPos _bpos = BlockPos.containing(x, y, z);
				_ent.openMenu(new MenuProvider() {
					@Override
		...
		} else if (entity.getData(PowerModVariables.PLAYER_VARIABLES).element_id_fist == 3) {
			if (entity instanceof ServerPlayer _ent) {
				BlockPos _bpos = BlockPos.containing(x, y, z);
				_ent.openMenu(new MenuProvider() {
					@Override
		...
		} else if (entity.getData(PowerModVariables.PLAYER_VARIABLES).element_id_fist == 4) {
			if (entity instanceof ServerPlayer _ent) {
				BlockPos _bpos = BlockPos.containing(x, y, z);
				_ent.openMenu(new MenuProvider() {
					@Override
		...
		} else if (entity.getData(PowerModVariables.PLAYER_VARIABLES).element_id_fist == 5) {
			if (entity instanceof ServerPlayer _ent) {
				BlockPos _bpos = BlockPos.containing(x, y, z);
				_ent.openMenu(new MenuProvider() {
					@Override
		...
		} else if (entity.getData(PowerModVariables.PLAYER_VARIABLES).element_id_fist == 6) {
			if (entity instanceof ServerPlayer _ent) {
				BlockPos _bpos = BlockPos.containing(x, y, z);
				_ent.openMenu(new MenuProvider() {
					@Override
		...
		} else if (entity.getData(PowerModVariables.PLAYER_VARIABLES).element_id_fist == 7) {
			if (entity instanceof ServerPlayer _ent) {
				BlockPos _bpos = BlockPos.containing(x, y, z);
				_ent.openMenu(new MenuProvider() {
					@Override
		...
		} else if (entity.getData(PowerModVariables.PLAYER_VARIABLES).element_id_fist == 8) {
			if (entity instanceof ServerPlayer _ent) {
				BlockPos _bpos = BlockPos.containing(x, y, z);
				_ent.openMenu(new MenuProvider() {
					@Override
		...
		} else if (entity.getData(PowerModVariables.PLAYER_VARIABLES).element_id_fist == 9) {
			if (entity instanceof ServerPlayer _ent) {
				BlockPos _bpos = BlockPos.containing(x, y, z);
				_ent.openMenu(new MenuProvider() {
					@Override
		...
		} else if (entity.getData(PowerModVariables.PLAYER_VARIABLES).element_id_fist == 10) {
			if (entity instanceof ServerPlayer _ent) {
				BlockPos _bpos = BlockPos.containing(x, y, z);
				_ent.openMenu(new MenuProvider() {
					@Override
		...
		} else if (entity.getData(PowerModVariables.PLAYER_VARIABLES).element_id_fist == 11) {
			if (entity instanceof ServerPlayer _ent) {
				BlockPos _bpos = BlockPos.containing(x, y, z);
				_ent.openMenu(new MenuProvider() {
					@Override
		...
		} else if (entity.getData(PowerModVariables.PLAYER_VARIABLES).element_id_fist == 12) {
			if (entity instanceof ServerPlayer _ent) {
				BlockPos _bpos = BlockPos.containing(x, y, z);
				_ent.openMenu(new MenuProvider() {
					@Override
		...
		} else if (entity.getData(PowerModVariables.PLAYER_VARIABLES).element_id_fist == 13) {
			if (entity instanceof ServerPlayer _ent) {
				BlockPos _bpos = BlockPos.containing(x, y, z);
				_ent.openMenu(new MenuProvider() {
					@Override
		...
		} else if (entity.getData(PowerModVariables.PLAYER_VARIABLES).element_id_fist == 14) {
			if (entity instanceof ServerPlayer _ent) {
				BlockPos _bpos = BlockPos.containing(x, y, z);
				_ent.openMenu(new MenuProvider() {
					@Override
		...
		} else if (entity.getData(PowerModVariables.PLAYER_VARIABLES).element_id_fist == 16) {
			if (entity instanceof ServerPlayer _ent) {
				BlockPos _bpos = BlockPos.containing(x, y, z);
				_ent.openMenu(new MenuProvider() {
					@Override
		...
		} else if (entity.getData(PowerModVariables.PLAYER_VARIABLES).element_id_fist == 17) {
			if (entity instanceof ServerPlayer _ent) {
				BlockPos _bpos = BlockPos.containing(x, y, z);
				_ent.openMenu(new MenuProvider() {
					@Override
		...
		} else if (entity.getData(PowerModVariables.PLAYER_VARIABLES).element_id_fist == 18) {
			if (entity instanceof ServerPlayer _ent) {
				BlockPos _bpos = BlockPos.containing(x, y, z);
				_ent.openMenu(new MenuProvider() {
					@Override
		...
		} else if (entity.getData(PowerModVariables.PLAYER_VARIABLES).element_id_fist == 19) {
			if (entity instanceof ServerPlayer _ent) {
				BlockPos _bpos = BlockPos.containing(x, y, z);
				_ent.openMenu(new MenuProvider() {
					@Override
		...
		} else if (entity.getData(PowerModVariables.PLAYER_VARIABLES).element_id_fist == 20) {
			if (entity instanceof ServerPlayer _ent) {
				BlockPos _bpos = BlockPos.containing(x, y, z);
				_ent.openMenu(new MenuProvider() {
					@Override
		...
		} else if (entity.getData(PowerModVariables.PLAYER_VARIABLES).element_id_fist == 21) {
			if (entity instanceof ServerPlayer _ent) {
				BlockPos _bpos = BlockPos.containing(x, y, z);
				_ent.openMenu(new MenuProvider() {
					@Override
