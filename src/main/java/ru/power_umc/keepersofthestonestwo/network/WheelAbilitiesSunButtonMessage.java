...
import ru.power_umc.keepersofthestonestwo.procedures.Attack83Procedure;
import ru.power_umc.keepersofthestonestwo.procedures.Attack82Procedure;
import ru.power_umc.keepersofthestonestwo.procedures.Attack81Procedure;
...
public record WheelAbilitiesSunButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static final ResourceLocation ID = new ResourceLocation(PowerMod.MODID, "wheel_abilities_sun_buttons");
	...
	public static void handleData(final WheelAbilitiesSunButtonMessage message, final PlayPayloadContext context) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PowerMod.addNetworkMessage(WheelAbilitiesSunButtonMessage.ID, WheelAbilitiesSunButtonMessage::new, WheelAbilitiesSunButtonMessage::handleData);
	}
}
