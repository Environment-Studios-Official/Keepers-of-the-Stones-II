...
public record WheelAbilitiesAnimalsButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static final ResourceLocation ID = new ResourceLocation(PowerMod.MODID, "wheel_abilities_animals_buttons");
	...
	public static void handleData(final WheelAbilitiesAnimalsButtonMessage message, final PlayPayloadContext context) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PowerMod.addNetworkMessage(WheelAbilitiesAnimalsButtonMessage.ID, WheelAbilitiesAnimalsButtonMessage::new, WheelAbilitiesAnimalsButtonMessage::handleData);
	}
}
