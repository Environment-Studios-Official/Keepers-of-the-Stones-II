...
public record WheelAbilitiesOceanButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static final ResourceLocation ID = new ResourceLocation(PowerMod.MODID, "wheel_abilities_ocean_buttons");
	...
	public static void handleData(final WheelAbilitiesOceanButtonMessage message, final PlayPayloadContext context) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PowerMod.addNetworkMessage(WheelAbilitiesOceanButtonMessage.ID, WheelAbilitiesOceanButtonMessage::new, WheelAbilitiesOceanButtonMessage::handleData);
	}
}
