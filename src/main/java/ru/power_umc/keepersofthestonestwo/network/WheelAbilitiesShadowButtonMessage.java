...
public record WheelAbilitiesShadowButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static final ResourceLocation ID = new ResourceLocation(PowerMod.MODID, "wheel_abilities_shadow_buttons");
	...
	public static void handleData(final WheelAbilitiesShadowButtonMessage message, final PlayPayloadContext context) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PowerMod.addNetworkMessage(WheelAbilitiesShadowButtonMessage.ID, WheelAbilitiesShadowButtonMessage::new, WheelAbilitiesShadowButtonMessage::handleData);
	}
}
