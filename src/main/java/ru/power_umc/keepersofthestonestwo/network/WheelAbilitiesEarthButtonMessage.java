...
public record WheelAbilitiesEarthButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static final ResourceLocation ID = new ResourceLocation(PowerMod.MODID, "wheel_abilities_earth_buttons");
	...
	public static void handleData(final WheelAbilitiesEarthButtonMessage message, final PlayPayloadContext context) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PowerMod.addNetworkMessage(WheelAbilitiesEarthButtonMessage.ID, WheelAbilitiesEarthButtonMessage::new, WheelAbilitiesEarthButtonMessage::handleData);
	}
}
