...
public class SpecialAttackProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (entity instanceof LivingEntity _livEnt259 && _livEnt259.hasEffect(PowerModMobEffects.ETHER_MASTER.get())) {
		...
		if (entity instanceof LivingEntity _livEnt313 && _livEnt313.hasEffect(PowerModMobEffects.ICE_MASTER.get())) {
		...
		if (entity instanceof LivingEntity _livEnt314 && _livEnt314.hasEffect(PowerModMobEffects.LIGHTNING_MASTER.get())) {
		...
		if (entity instanceof LivingEntity _livEnt315 && _livEnt315.hasEffect(PowerModMobEffects.SOUND_MASTER.get())) {
