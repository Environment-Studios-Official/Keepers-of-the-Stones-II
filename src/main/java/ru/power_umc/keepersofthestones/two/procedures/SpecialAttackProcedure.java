...
public class SpecialAttackProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (entity instanceof LivingEntity _livEnt341 && _livEnt341.hasEffect(PowerModMobEffects.SOUND_MASTER.get())) {
		...
		if (entity instanceof LivingEntity _livEnt342 && _livEnt342.hasEffect(PowerModMobEffects.CRYSTAL_MASTER.get())) {
		...
		if (entity instanceof LivingEntity _livEnt343 && _livEnt343.hasEffect(PowerModMobEffects.LAVA_MASTER.get())) {
