...
import ru.power_umc.keepersofthestones.two.world.inventory.WheelAbilitiesCrystalMenu;
...
import ru.power_umc.keepersofthestones.two.network.WheelAbilitiesCrystalButtonMessage;
...
public class WheelAbilitiesCrystalScreen extends AbstractContainerScreen<WheelAbilitiesCrystalMenu> {
	...
	public void init() {
		super.init();
		button_1 = Button.builder(Component.translatable("gui.power.wheel_abilities_crystal.button_1"), e -> {
			if (true) {
		...
		button_2 = Button.builder(Component.translatable("gui.power.wheel_abilities_crystal.button_2"), e -> {
			if (true) {
		...
		button_3 = Button.builder(Component.translatable("gui.power.wheel_abilities_crystal.button_3"), e -> {
			if (true) {
