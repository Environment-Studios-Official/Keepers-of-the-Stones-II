...
import ru.power_umc.keepersofthestones.two.network.WheelAbilitiesSoundButtonMessage;
...
public class WheelAbilitiesSoundScreen extends AbstractContainerScreen<WheelAbilitiesSoundMenu> {
	...
	public void init() {
		super.init();
		button_1 = Button.builder(Component.translatable("gui.power.wheel_abilities_sound.button_1"), e -> {
			if (true) {
		...
		button_2 = Button.builder(Component.translatable("gui.power.wheel_abilities_sound.button_2"), e -> {
			if (true) {
		...
		button_3 = Button.builder(Component.translatable("gui.power.wheel_abilities_sound.button_3"), e -> {
			if (true) {
