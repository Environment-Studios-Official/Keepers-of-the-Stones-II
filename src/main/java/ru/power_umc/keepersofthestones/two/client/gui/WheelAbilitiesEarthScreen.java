...
public class WheelAbilitiesEarthScreen extends AbstractContainerScreen<WheelAbilitiesEarthMenu> {
	...
	public void init() {
		super.init();
		button_1 = Button.builder(Component.translatable("gui.power.wheel_abilities_earth.button_1"), e -> {
			if (true) {
		...
		button_2 = Button.builder(Component.translatable("gui.power.wheel_abilities_earth.button_2"), e -> {
			if (true) {
