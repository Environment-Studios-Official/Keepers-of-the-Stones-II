...
public class WheelAbilitiesFireScreen extends AbstractContainerScreen<WheelAbilitiesFireMenu> {
	...
	public void init() {
		super.init();
		imagebutton_flamethrower = new ImageButton(this.leftPos + 73, this.topPos + 12, 46, 46, 0, 0, 46, new ResourceLocation("power:textures/screens/atlas/imagebutton_flamethrower.png"), 46, 92, e -> {
			if (true) {
		...
		imagebutton_triple_fireball = new ImageButton(this.leftPos + 134, this.topPos + 73, 46, 46, 0, 0, 46, new ResourceLocation("power:textures/screens/atlas/imagebutton_triple_fireball.png"), 46, 92, e -> {
			if (true) {
		...
		imagebutton_jet_fire = new ImageButton(this.leftPos + 12, this.topPos + 73, 46, 46, 0, 0, 46, new ResourceLocation("power:textures/screens/atlas/imagebutton_jet_fire.png"), 46, 92, e -> {
			if (true) {
