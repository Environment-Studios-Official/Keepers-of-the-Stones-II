...
public class CopperAttackProjectileEntity extends AbstractArrow implements ItemSupplier {
	...
	public CopperAttackProjectileEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(KeepersOfTheStones2ModEntities.COPPER_ATTACK_PROJECTILE.get(), world);
	}
	...
	public static CopperAttackProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		CopperAttackProjectileEntity entityarrow = new CopperAttackProjectileEntity(KeepersOfTheStones2ModEntities.COPPER_ATTACK_PROJECTILE.get(), entity, world);
	...
	public static CopperAttackProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
		CopperAttackProjectileEntity entityarrow = new CopperAttackProjectileEntity(KeepersOfTheStones2ModEntities.COPPER_ATTACK_PROJECTILE.get(), entity, entity.level());
