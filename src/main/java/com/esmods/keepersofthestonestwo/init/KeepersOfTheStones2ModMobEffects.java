...
public class KeepersOfTheStones2ModMobEffects {
	public static final DeferredRegister<MobEffect> REGISTRY = DeferredRegister.create(ForgeRegistries.MOB_EFFECTS, KeepersOfTheStones2Mod.MODID);
