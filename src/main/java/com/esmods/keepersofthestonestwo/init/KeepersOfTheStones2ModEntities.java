...
public class KeepersOfTheStones2ModEntities {
	public static final DeferredRegister<EntityType<?>> REGISTRY = DeferredRegister.create(ForgeRegistries.ENTITY_TYPES, KeepersOfTheStones2Mod.MODID);
