...
public class PowerModSounds {
	...
	public static final DeferredHolder<SoundEvent, SoundEvent> TIME_ABILITY_EFFECT = REGISTRY.register("time_ability_effect", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation("power", "time_ability_effect")));
	public static final DeferredHolder<SoundEvent, SoundEvent> MUSKET = REGISTRY.register("musket", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation("power", "musket")));
}
