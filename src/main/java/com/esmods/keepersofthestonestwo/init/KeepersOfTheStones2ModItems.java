...
public class KeepersOfTheStones2ModItems {
	public static final DeferredRegister<Item> REGISTRY = DeferredRegister.create(ForgeRegistries.ITEMS, KeepersOfTheStones2Mod.MODID);
	...
	public static final RegistryObject<Item> KEEPERS_BOX = block(KeepersOfTheStones2ModBlocks.KEEPERS_BOX);
	public static final RegistryObject<Item> DEPLETED_ENERGIUM_ORE = block(KeepersOfTheStones2ModBlocks.DEPLETED_ENERGIUM_ORE);
	public static final RegistryObject<Item> DEPLETED_ENERGIUM_BLOCK = block(KeepersOfTheStones2ModBlocks.DEPLETED_ENERGIUM_BLOCK);
	public static final RegistryObject<Item> ENERGIUM_BLOCK = block(KeepersOfTheStones2ModBlocks.ENERGIUM_BLOCK);
	public static final RegistryObject<Item> ENERGIUM_CONTROLLER = block(KeepersOfTheStones2ModBlocks.ENERGIUM_CONTROLLER);
	...
	public static final RegistryObject<Item> BATTERY_CHARGER = block(KeepersOfTheStones2ModBlocks.BATTERY_CHARGER);
	...
	public static final RegistryObject<Item> MOON_BLOCK = block(KeepersOfTheStones2ModBlocks.MOON_BLOCK);
	...
	public static void clientLoad(FMLClientSetupEvent event) {
		event.enqueueWork(() -> {
			ItemProperties.register(FIRE_STONE.get(), new ResourceLocation("keepers_of_the_stones_2:fire_stone_recharge"), (itemStackToRender, clientWorld, entity, itemEntityId) -> (float) StoneGetRechargeStateProcedure.execute(itemStackToRender));
			ItemProperties.register(AIR_STONE.get(), new ResourceLocation("keepers_of_the_stones_2:air_stone_recharge"), (itemStackToRender, clientWorld, entity, itemEntityId) -> (float) StoneGetRechargeStateProcedure.execute(itemStackToRender));
			ItemProperties.register(EARTH_STONE.get(), new ResourceLocation("keepers_of_the_stones_2:earth_stone_recharge"), (itemStackToRender, clientWorld, entity, itemEntityId) -> (float) StoneGetRechargeStateProcedure.execute(itemStackToRender));
			ItemProperties.register(WATER_STONE.get(), new ResourceLocation("keepers_of_the_stones_2:water_stone_recharge"), (itemStackToRender, clientWorld, entity, itemEntityId) -> (float) StoneGetRechargeStateProcedure.execute(itemStackToRender));
			ItemProperties.register(ETHER_STONE.get(), new ResourceLocation("keepers_of_the_stones_2:ether_stone_recharge"), (itemStackToRender, clientWorld, entity, itemEntityId) -> (float) StoneGetRechargeStateProcedure.execute(itemStackToRender));
			ItemProperties.register(ICE_STONE.get(), new ResourceLocation("keepers_of_the_stones_2:ice_stone_recharge"), (itemStackToRender, clientWorld, entity, itemEntityId) -> (float) StoneGetRechargeStateProcedure.execute(itemStackToRender));
			ItemProperties.register(LIGHTNING_STONE.get(), new ResourceLocation("keepers_of_the_stones_2:lightning_stone_recharge"),
					(itemStackToRender, clientWorld, entity, itemEntityId) -> (float) StoneGetRechargeStateProcedure.execute(itemStackToRender));
			ItemProperties.register(SOUND_STONE.get(), new ResourceLocation("keepers_of_the_stones_2:sound_stone_recharge"), (itemStackToRender, clientWorld, entity, itemEntityId) -> (float) StoneGetRechargeStateProcedure.execute(itemStackToRender));
			ItemProperties.register(CRYSTAL_STONE.get(), new ResourceLocation("keepers_of_the_stones_2:crystal_stone_recharge"),
					(itemStackToRender, clientWorld, entity, itemEntityId) -> (float) StoneGetRechargeStateProcedure.execute(itemStackToRender));
			ItemProperties.register(LAVA_STONE.get(), new ResourceLocation("keepers_of_the_stones_2:lava_stone_recharge"), (itemStackToRender, clientWorld, entity, itemEntityId) -> (float) StoneGetRechargeStateProcedure.execute(itemStackToRender));
			ItemProperties.register(RAIN_STONE.get(), new ResourceLocation("keepers_of_the_stones_2:rain_stone_recharge"), (itemStackToRender, clientWorld, entity, itemEntityId) -> (float) StoneGetRechargeStateProcedure.execute(itemStackToRender));
			ItemProperties.register(TORNADO_STONE.get(), new ResourceLocation("keepers_of_the_stones_2:tornado_stone_recharge"),
					(itemStackToRender, clientWorld, entity, itemEntityId) -> (float) StoneGetRechargeStateProcedure.execute(itemStackToRender));
			ItemProperties.register(OCEAN_STONE.get(), new ResourceLocation("keepers_of_the_stones_2:ocean_stone_recharge"), (itemStackToRender, clientWorld, entity, itemEntityId) -> (float) StoneGetRechargeStateProcedure.execute(itemStackToRender));
			ItemProperties.register(PLANTS_STONE.get(), new ResourceLocation("keepers_of_the_stones_2:plants_stone_recharge"),
					(itemStackToRender, clientWorld, entity, itemEntityId) -> (float) StoneGetRechargeStateProcedure.execute(itemStackToRender));
			ItemProperties.register(ANIMALS_STONE.get(), new ResourceLocation("keepers_of_the_stones_2:animals_stone_recharge"),
					(itemStackToRender, clientWorld, entity, itemEntityId) -> (float) StoneGetRechargeStateProcedure.execute(itemStackToRender));
			ItemProperties.register(METAL_STONE.get(), new ResourceLocation("keepers_of_the_stones_2:metal_stone_recharge"), (itemStackToRender, clientWorld, entity, itemEntityId) -> (float) StoneGetRechargeStateProcedure.execute(itemStackToRender));
			ItemProperties.register(LIGHT_STONE.get(), new ResourceLocation("keepers_of_the_stones_2:light_stone_recharge"), (itemStackToRender, clientWorld, entity, itemEntityId) -> (float) StoneGetRechargeStateProcedure.execute(itemStackToRender));
			ItemProperties.register(SHADOW_STONE.get(), new ResourceLocation("keepers_of_the_stones_2:shadow_stone_recharge"),
					(itemStackToRender, clientWorld, entity, itemEntityId) -> (float) StoneGetRechargeStateProcedure.execute(itemStackToRender));
			ItemProperties.register(VACUUM_STONE.get(), new ResourceLocation("keepers_of_the_stones_2:vacuum_stone_recharge"),
					(itemStackToRender, clientWorld, entity, itemEntityId) -> (float) StoneGetRechargeStateProcedure.execute(itemStackToRender));
			ItemProperties.register(ENERGY_STONE.get(), new ResourceLocation("keepers_of_the_stones_2:energy_stone_recharge"),
					(itemStackToRender, clientWorld, entity, itemEntityId) -> (float) StoneGetRechargeStateProcedure.execute(itemStackToRender));
			ItemProperties.register(SUN_STONE.get(), new ResourceLocation("keepers_of_the_stones_2:sun_stone_recharge"), (itemStackToRender, clientWorld, entity, itemEntityId) -> (float) StoneGetRechargeStateProcedure.execute(itemStackToRender));
			ItemProperties.register(MOON_STONE.get(), new ResourceLocation("keepers_of_the_stones_2:moon_stone_recharge"), (itemStackToRender, clientWorld, entity, itemEntityId) -> (float) StoneGetRechargeStateProcedure.execute(itemStackToRender));
			ItemProperties.register(SPACE_STONE.get(), new ResourceLocation("keepers_of_the_stones_2:space_stone_recharge"), (itemStackToRender, clientWorld, entity, itemEntityId) -> (float) StoneGetRechargeStateProcedure.execute(itemStackToRender));
			ItemProperties.register(TIME_STONE.get(), new ResourceLocation("keepers_of_the_stones_2:time_stone_recharge"), (itemStackToRender, clientWorld, entity, itemEntityId) -> (float) StoneGetRechargeStateProcedure.execute(itemStackToRender));
			ItemProperties.register(CREATION_STONE.get(), new ResourceLocation("keepers_of_the_stones_2:creation_stone_recharge"),
					(itemStackToRender, clientWorld, entity, itemEntityId) -> (float) StoneGetRechargeStateProcedure.execute(itemStackToRender));
			ItemProperties.register(BLOOD_STONE.get(), new ResourceLocation("keepers_of_the_stones_2:blood_stone_recharge"), (itemStackToRender, clientWorld, entity, itemEntityId) -> (float) StoneGetRechargeStateProcedure.execute(itemStackToRender));
			ItemProperties.register(TECHNOLOGY_STONE.get(), new ResourceLocation("keepers_of_the_stones_2:technology_stone_recharge"),
					(itemStackToRender, clientWorld, entity, itemEntityId) -> (float) StoneGetRechargeStateProcedure.execute(itemStackToRender));
			ItemProperties.register(TELEPORTATION_STONE.get(), new ResourceLocation("keepers_of_the_stones_2:teleportation_stone_recharge"),
					(itemStackToRender, clientWorld, entity, itemEntityId) -> (float) StoneGetRechargeStateProcedure.execute(itemStackToRender));
			ItemProperties.register(EXPLOSION_STONE.get(), new ResourceLocation("keepers_of_the_stones_2:explosion_stone_recharge"),
					(itemStackToRender, clientWorld, entity, itemEntityId) -> (float) StoneGetRechargeStateProcedure.execute(itemStackToRender));
			ItemProperties.register(AMBER_STONE.get(), new ResourceLocation("keepers_of_the_stones_2:amber_stone_recharge"), (itemStackToRender, clientWorld, entity, itemEntityId) -> (float) StoneGetRechargeStateProcedure.execute(itemStackToRender));
			ItemProperties.register(DESTRUCTION_STONE.get(), new ResourceLocation("keepers_of_the_stones_2:destruction_stone_recharge"),
					(itemStackToRender, clientWorld, entity, itemEntityId) -> (float) StoneGetRechargeStateProcedure.execute(itemStackToRender));
			ItemProperties.register(MIST_STONE.get(), new ResourceLocation("keepers_of_the_stones_2:mist_stone_recharge"), (itemStackToRender, clientWorld, entity, itemEntityId) -> (float) StoneGetRechargeStateProcedure.execute(itemStackToRender));
			ItemProperties.register(SAND_STONE.get(), new ResourceLocation("keepers_of_the_stones_2:sand_stone_recharge"), (itemStackToRender, clientWorld, entity, itemEntityId) -> (float) StoneGetRechargeStateProcedure.execute(itemStackToRender));
			ItemProperties.register(SPEED_STONE.get(), new ResourceLocation("keepers_of_the_stones_2:speed_stone_recharge"), (itemStackToRender, clientWorld, entity, itemEntityId) -> (float) StoneGetRechargeStateProcedure.execute(itemStackToRender));
			ItemProperties.register(POISON_STONE.get(), new ResourceLocation("keepers_of_the_stones_2:poison_stone_recharge"),
					(itemStackToRender, clientWorld, entity, itemEntityId) -> (float) StoneGetRechargeStateProcedure.execute(itemStackToRender));
			ItemProperties.register(MAGNET_STONE.get(), new ResourceLocation("keepers_of_the_stones_2:magnet_stone_recharge"),
					(itemStackToRender, clientWorld, entity, itemEntityId) -> (float) StoneGetRechargeStateProcedure.execute(itemStackToRender));
			ItemProperties.register(MUSHROOMS_STONE.get(), new ResourceLocation("keepers_of_the_stones_2:mushrooms_stone_recharge"),
					(itemStackToRender, clientWorld, entity, itemEntityId) -> (float) StoneGetRechargeStateProcedure.execute(itemStackToRender));
			ItemProperties.register(MERCURY_STONE.get(), new ResourceLocation("keepers_of_the_stones_2:mercury_stone_recharge"),
					(itemStackToRender, clientWorld, entity, itemEntityId) -> (float) StoneGetRechargeStateProcedure.execute(itemStackToRender));
			ItemProperties.register(MUSIC_STONE.get(), new ResourceLocation("keepers_of_the_stones_2:music_stone_recharge"), (itemStackToRender, clientWorld, entity, itemEntityId) -> (float) StoneGetRechargeStateProcedure.execute(itemStackToRender));
			ItemProperties.register(PLAGUE_STONE.get(), new ResourceLocation("keepers_of_the_stones_2:plague_stone_recharge"),
					(itemStackToRender, clientWorld, entity, itemEntityId) -> (float) StoneGetRechargeStateProcedure.execute(itemStackToRender));
			ItemProperties.register(BLUE_FLAME_STONE.get(), new ResourceLocation("keepers_of_the_stones_2:blue_flame_stone_recharge"),
					(itemStackToRender, clientWorld, entity, itemEntityId) -> (float) StoneGetRechargeStateProcedure.execute(itemStackToRender));
			ItemProperties.register(GRAVITY_STONE.get(), new ResourceLocation("keepers_of_the_stones_2:gravity_stone_recharge"),
					(itemStackToRender, clientWorld, entity, itemEntityId) -> (float) StoneGetRechargeStateProcedure.execute(itemStackToRender));
			ItemProperties.register(SMOKE_STONE.get(), new ResourceLocation("keepers_of_the_stones_2:smoke_stone_recharge"), (itemStackToRender, clientWorld, entity, itemEntityId) -> (float) StoneGetRechargeStateProcedure.execute(itemStackToRender));
			ItemProperties.register(FORM_STONE.get(), new ResourceLocation("keepers_of_the_stones_2:form_stone_recharge"), (itemStackToRender, clientWorld, entity, itemEntityId) -> (float) StoneGetRechargeStateProcedure.execute(itemStackToRender));
			ItemProperties.register(MIND_STONE.get(), new ResourceLocation("keepers_of_the_stones_2:mind_stone_recharge"), (itemStackToRender, clientWorld, entity, itemEntityId) -> (float) StoneGetRechargeStateProcedure.execute(itemStackToRender));
			ItemProperties.register(GOLDEN_DUST_STONE.get(), new ResourceLocation("keepers_of_the_stones_2:golden_dust_stone_recharge"),
					(itemStackToRender, clientWorld, entity, itemEntityId) -> (float) StoneGetRechargeStateProcedure.execute(itemStackToRender));
			ItemProperties.register(DARKNESS_STONE.get(), new ResourceLocation("keepers_of_the_stones_2:darkness_stone_recharge"),
					(itemStackToRender, clientWorld, entity, itemEntityId) -> (float) StoneGetRechargeStateProcedure.execute(itemStackToRender));
			ItemProperties.register(SPIRIT_STONE.get(), new ResourceLocation("keepers_of_the_stones_2:spirit_stone_recharge"),
					(itemStackToRender, clientWorld, entity, itemEntityId) -> (float) StoneGetRechargeStateProcedure.execute(itemStackToRender));
		});
	}
}
