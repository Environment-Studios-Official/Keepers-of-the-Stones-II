...
public class WheelAbilitiesTimeScreen extends AbstractContainerScreen<WheelAbilitiesTimeMenu> {
	...
	public void init() {
		super.init();
		button_1 = Button.builder(Component.translatable("gui.power.wheel_abilities_time.button_1"), e -> {
			if (true) {
		...
		}).bounds(this.leftPos + 78, this.topPos + 26, 30, 20).build();
		guistate.put("button:button_1", button_1);
		this.addRenderableWidget(button_1);
		button_2 = Button.builder(Component.translatable("gui.power.wheel_abilities_time.button_2"), e -> {
			if (true) {
		...
		button_3 = Button.builder(Component.translatable("gui.power.wheel_abilities_time.button_3"), e -> {
			if (true) {
