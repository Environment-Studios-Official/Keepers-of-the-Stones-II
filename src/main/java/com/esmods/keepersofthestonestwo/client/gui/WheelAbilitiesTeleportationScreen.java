...
public class WheelAbilitiesTeleportationScreen extends AbstractContainerScreen<WheelAbilitiesTeleportationMenu> {
	...
	public void init() {
		super.init();
		button_1 = Button.builder(Component.translatable("gui.power.wheel_abilities_teleportation.button_1"), e -> {
			if (true) {
		...
		button_2 = Button.builder(Component.translatable("gui.power.wheel_abilities_teleportation.button_2"), e -> {
			if (true) {
		...
		}).bounds(this.leftPos + 140, this.topPos + 85, 30, 20).build();
		guistate.put("button:button_2", button_2);
		this.addRenderableWidget(button_2);
		button_3 = Button.builder(Component.translatable("gui.power.wheel_abilities_teleportation.button_3"), e -> {
			if (true) {
