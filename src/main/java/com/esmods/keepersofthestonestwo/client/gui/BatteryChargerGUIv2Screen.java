...
public class BatteryChargerGUIv2Screen extends AbstractContainerScreen<BatteryChargerGUIv2Menu> {
	private final static HashMap<String, Object> guistate = BatteryChargerGUIv2Menu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public BatteryChargerGUIv2Screen(BatteryChargerGUIv2Menu container, Inventory inventory, Component text) {
