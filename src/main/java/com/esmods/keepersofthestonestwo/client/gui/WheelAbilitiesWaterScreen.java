...
public class WheelAbilitiesWaterScreen extends AbstractContainerScreen<WheelAbilitiesWaterMenu> {
	...
	public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > leftPos + 82 && mouseX < leftPos + 106 && mouseY > topPos + 22 && mouseY < topPos + 46)
			guiGraphics.renderTooltip(font, Component.translatable("gui.keepers_of_the_stones_2.wheel_abilities_water.tooltip_water_stream_uses_10_power_poin"), mouseX, mouseY);
		if (mouseX > leftPos + 144 && mouseX < leftPos + 168 && mouseY > topPos + 84 && mouseY < topPos + 108)
			guiGraphics.renderTooltip(font, Component.translatable("gui.keepers_of_the_stones_2.wheel_abilities_water.tooltip_water_shock_uses_20_power_point"), mouseX, mouseY);
		if (mouseX > leftPos + 83 && mouseX < leftPos + 107 && mouseY > topPos + 145 && mouseY < topPos + 169)
			guiGraphics.renderTooltip(font, Component.translatable("gui.keepers_of_the_stones_2.wheel_abilities_water.tooltip_healing_water_uses_30_power_poi"), mouseX, mouseY);
	}
	...
	public void init() {
		...
		imagebutton_wheel_button_1 = new ImageButton(this.leftPos + 140, this.topPos + 154, 10, 7, 0, 0, 7, new ResourceLocation("keepers_of_the_stones_2:textures/screens/atlas/imagebutton_wheel_button_1.png"), 10, 14, e -> {
			if (GetWheelTwoProcedure.execute(entity)) {
				KeepersOfTheStones2Mod.PACKET_HANDLER.sendToServer(new WheelAbilitiesWaterButtonMessage(0, x, y, z));
		...
		imagebutton_wheel_button_2 = new ImageButton(this.leftPos + 152, this.topPos + 154, 10, 7, 0, 0, 7, new ResourceLocation("keepers_of_the_stones_2:textures/screens/atlas/imagebutton_wheel_button_2.png"), 10, 14, e -> {
			if (GetWheelTwoProcedure.execute(entity)) {
				KeepersOfTheStones2Mod.PACKET_HANDLER.sendToServer(new WheelAbilitiesWaterButtonMessage(1, x, y, z));
		...
		imagebutton_wheel_button_3 = new ImageButton(this.leftPos + 164, this.topPos + 154, 10, 7, 0, 0, 7, new ResourceLocation("keepers_of_the_stones_2:textures/screens/atlas/imagebutton_wheel_button_3.png"), 10, 14, e -> {
			if (GetWheelThreeProcedure.execute(entity)) {
				KeepersOfTheStones2Mod.PACKET_HANDLER.sendToServer(new WheelAbilitiesWaterButtonMessage(2, x, y, z));
		...
		imagebutton_water_stream = new ImageButton(this.leftPos + 72, this.topPos + 12, 46, 46, 0, 0, 46, new ResourceLocation("keepers_of_the_stones_2:textures/screens/atlas/imagebutton_water_stream.png"), 46, 92, e -> {
			if (true) {
				KeepersOfTheStones2Mod.PACKET_HANDLER.sendToServer(new WheelAbilitiesWaterButtonMessage(3, x, y, z));
		...
		imagebutton_water_shock = new ImageButton(this.leftPos + 133, this.topPos + 73, 46, 46, 0, 0, 46, new ResourceLocation("keepers_of_the_stones_2:textures/screens/atlas/imagebutton_water_shock.png"), 46, 92, e -> {
			if (true) {
				KeepersOfTheStones2Mod.PACKET_HANDLER.sendToServer(new WheelAbilitiesWaterButtonMessage(4, x, y, z));
		...
		imagebutton_healing_water = new ImageButton(this.leftPos + 72, this.topPos + 134, 46, 46, 0, 0, 46, new ResourceLocation("keepers_of_the_stones_2:textures/screens/atlas/imagebutton_healing_water.png"), 46, 92, e -> {
			if (true) {
				KeepersOfTheStones2Mod.PACKET_HANDLER.sendToServer(new WheelAbilitiesWaterButtonMessage(5, x, y, z));
