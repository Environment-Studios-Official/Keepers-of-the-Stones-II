...
public class TurretRenderer extends GeoEntityRenderer<TurretEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, TurretEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1f;
