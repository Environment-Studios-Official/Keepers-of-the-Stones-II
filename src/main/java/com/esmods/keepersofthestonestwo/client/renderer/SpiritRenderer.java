...
public class SpiritRenderer extends GeoEntityRenderer<SpiritEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, SpiritEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
		float scale = 1f;
