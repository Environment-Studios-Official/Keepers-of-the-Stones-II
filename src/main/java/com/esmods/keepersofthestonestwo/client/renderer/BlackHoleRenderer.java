...
public class BlackHoleRenderer extends GeoEntityRenderer<BlackHoleEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, BlackHoleEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
		float scale = 1f;
