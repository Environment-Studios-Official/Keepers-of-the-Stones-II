...
public class EnergiumGolemRenderer extends GeoEntityRenderer<EnergiumGolemEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, EnergiumGolemEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1f;
