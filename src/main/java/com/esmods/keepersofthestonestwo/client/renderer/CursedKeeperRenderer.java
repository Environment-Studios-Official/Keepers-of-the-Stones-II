...
public class CursedKeeperRenderer extends GeoEntityRenderer<CursedKeeperEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, CursedKeeperEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
		float scale = 1f;
