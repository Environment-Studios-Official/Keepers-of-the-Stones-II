...
public record WheelAbilitiesEnergyButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static final ResourceLocation ID = new ResourceLocation(PowerMod.MODID, "wheel_abilities_energy_buttons");
	...
	public static void handleData(final WheelAbilitiesEnergyButtonMessage message, final PlayPayloadContext context) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PowerMod.addNetworkMessage(WheelAbilitiesEnergyButtonMessage.ID, WheelAbilitiesEnergyButtonMessage::new, WheelAbilitiesEnergyButtonMessage::handleData);
	}
}
