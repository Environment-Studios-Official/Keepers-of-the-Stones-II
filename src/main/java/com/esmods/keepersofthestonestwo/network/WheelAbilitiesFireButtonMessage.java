...
public record WheelAbilitiesFireButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static final ResourceLocation ID = new ResourceLocation(PowerMod.MODID, "wheel_abilities_fire_buttons");
	...
	public static void handleData(final WheelAbilitiesFireButtonMessage message, final PlayPayloadContext context) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PowerMod.addNetworkMessage(WheelAbilitiesFireButtonMessage.ID, WheelAbilitiesFireButtonMessage::new, WheelAbilitiesFireButtonMessage::handleData);
	}
}
