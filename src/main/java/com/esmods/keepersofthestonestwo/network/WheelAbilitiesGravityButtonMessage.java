...
public class WheelAbilitiesGravityButtonMessage {
	private final int buttonID, x, y, z;

	public WheelAbilitiesGravityButtonMessage(FriendlyByteBuf buffer) {
	...
	public WheelAbilitiesGravityButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(WheelAbilitiesGravityButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(WheelAbilitiesGravityButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PowerMod.addNetworkMessage(WheelAbilitiesGravityButtonMessage.class, WheelAbilitiesGravityButtonMessage::buffer, WheelAbilitiesGravityButtonMessage::new, WheelAbilitiesGravityButtonMessage::handler);
	}
}
