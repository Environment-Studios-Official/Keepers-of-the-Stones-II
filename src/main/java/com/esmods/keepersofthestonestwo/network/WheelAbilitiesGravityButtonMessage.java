...
public record WheelAbilitiesGravityButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static final ResourceLocation ID = new ResourceLocation(PowerMod.MODID, "wheel_abilities_gravity_buttons");
	...
	public static void handleData(final WheelAbilitiesGravityButtonMessage message, final PlayPayloadContext context) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PowerMod.addNetworkMessage(WheelAbilitiesGravityButtonMessage.ID, WheelAbilitiesGravityButtonMessage::new, WheelAbilitiesGravityButtonMessage::handleData);
	}
}
