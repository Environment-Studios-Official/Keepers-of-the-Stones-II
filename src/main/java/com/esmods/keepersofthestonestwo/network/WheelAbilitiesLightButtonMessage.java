...
public record WheelAbilitiesLightButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static final ResourceLocation ID = new ResourceLocation(PowerMod.MODID, "wheel_abilities_light_buttons");
	...
	public static void handleData(final WheelAbilitiesLightButtonMessage message, final PlayPayloadContext context) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PowerMod.addNetworkMessage(WheelAbilitiesLightButtonMessage.ID, WheelAbilitiesLightButtonMessage::new, WheelAbilitiesLightButtonMessage::handleData);
	}
}
