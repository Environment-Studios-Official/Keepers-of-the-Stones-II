...
public record WheelAbilitiesPoisonButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static final ResourceLocation ID = new ResourceLocation(PowerMod.MODID, "wheel_abilities_poison_buttons");
	...
	public static void handleData(final WheelAbilitiesPoisonButtonMessage message, final PlayPayloadContext context) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PowerMod.addNetworkMessage(WheelAbilitiesPoisonButtonMessage.ID, WheelAbilitiesPoisonButtonMessage::new, WheelAbilitiesPoisonButtonMessage::handleData);
	}
}
