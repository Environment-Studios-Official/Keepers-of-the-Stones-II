...
public record WheelAbilitiesIceButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static final ResourceLocation ID = new ResourceLocation(PowerMod.MODID, "wheel_abilities_ice_buttons");
	...
	public static void handleData(final WheelAbilitiesIceButtonMessage message, final PlayPayloadContext context) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PowerMod.addNetworkMessage(WheelAbilitiesIceButtonMessage.ID, WheelAbilitiesIceButtonMessage::new, WheelAbilitiesIceButtonMessage::handleData);
	}
}
