...
public record WheelAbilitiesCreationButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static final ResourceLocation ID = new ResourceLocation(PowerMod.MODID, "wheel_abilities_creation_buttons");
	...
	public static void handleData(final WheelAbilitiesCreationButtonMessage message, final PlayPayloadContext context) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PowerMod.addNetworkMessage(WheelAbilitiesCreationButtonMessage.ID, WheelAbilitiesCreationButtonMessage::new, WheelAbilitiesCreationButtonMessage::handleData);
	}
}
