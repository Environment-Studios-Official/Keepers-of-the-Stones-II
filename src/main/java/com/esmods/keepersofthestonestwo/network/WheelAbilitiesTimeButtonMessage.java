...
public record WheelAbilitiesTimeButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static final ResourceLocation ID = new ResourceLocation(PowerMod.MODID, "wheel_abilities_time_buttons");
	...
	public static void handleData(final WheelAbilitiesTimeButtonMessage message, final PlayPayloadContext context) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PowerMod.addNetworkMessage(WheelAbilitiesTimeButtonMessage.ID, WheelAbilitiesTimeButtonMessage::new, WheelAbilitiesTimeButtonMessage::handleData);
	}
}
