...
public record WheelAbilitiesTeleportationButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static final ResourceLocation ID = new ResourceLocation(PowerMod.MODID, "wheel_abilities_teleportation_buttons");
	...
	public static void handleData(final WheelAbilitiesTeleportationButtonMessage message, final PlayPayloadContext context) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PowerMod.addNetworkMessage(WheelAbilitiesTeleportationButtonMessage.ID, WheelAbilitiesTeleportationButtonMessage::new, WheelAbilitiesTeleportationButtonMessage::handleData);
	}
}
