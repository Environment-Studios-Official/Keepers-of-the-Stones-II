...
public record WheelAbilitiesTeleportationButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static final Type<WheelAbilitiesTeleportationButtonMessage> TYPE = new Type<>(new ResourceLocation(PowerMod.MODID, "wheel_abilities_teleportation_buttons"));
