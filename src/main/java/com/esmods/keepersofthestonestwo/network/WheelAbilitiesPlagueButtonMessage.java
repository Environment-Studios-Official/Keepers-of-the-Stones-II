...
public class WheelAbilitiesPlagueButtonMessage {
	private final int buttonID, x, y, z;

	public WheelAbilitiesPlagueButtonMessage(FriendlyByteBuf buffer) {
	...
	public WheelAbilitiesPlagueButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(WheelAbilitiesPlagueButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(WheelAbilitiesPlagueButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PowerMod.addNetworkMessage(WheelAbilitiesPlagueButtonMessage.class, WheelAbilitiesPlagueButtonMessage::buffer, WheelAbilitiesPlagueButtonMessage::new, WheelAbilitiesPlagueButtonMessage::handler);
	}
}
