...
public record WheelAbilitiesPlagueButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static final ResourceLocation ID = new ResourceLocation(PowerMod.MODID, "wheel_abilities_plague_buttons");
	...
	public static void handleData(final WheelAbilitiesPlagueButtonMessage message, final PlayPayloadContext context) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PowerMod.addNetworkMessage(WheelAbilitiesPlagueButtonMessage.ID, WheelAbilitiesPlagueButtonMessage::new, WheelAbilitiesPlagueButtonMessage::handleData);
	}
}
