...
public record WheelAbilitiesRainButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static final ResourceLocation ID = new ResourceLocation(PowerMod.MODID, "wheel_abilities_rain_buttons");
	...
	public static void handleData(final WheelAbilitiesRainButtonMessage message, final PlayPayloadContext context) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PowerMod.addNetworkMessage(WheelAbilitiesRainButtonMessage.ID, WheelAbilitiesRainButtonMessage::new, WheelAbilitiesRainButtonMessage::handleData);
	}
}
