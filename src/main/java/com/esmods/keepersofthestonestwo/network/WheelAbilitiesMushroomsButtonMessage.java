...
public record WheelAbilitiesMushroomsButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static final ResourceLocation ID = new ResourceLocation(PowerMod.MODID, "wheel_abilities_mushrooms_buttons");
	public WheelAbilitiesMushroomsButtonMessage(FriendlyByteBuf buffer) {
	...
	public static void handleData(final WheelAbilitiesMushroomsButtonMessage message, final PlayPayloadContext context) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PowerMod.addNetworkMessage(WheelAbilitiesMushroomsButtonMessage.ID, WheelAbilitiesMushroomsButtonMessage::new, WheelAbilitiesMushroomsButtonMessage::handleData);
	}
}
