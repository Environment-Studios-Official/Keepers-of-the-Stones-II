...
public record WheelAbilitiesTechnologyButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static final ResourceLocation ID = new ResourceLocation(PowerMod.MODID, "wheel_abilities_technology_buttons");
	...
	public static void handleData(final WheelAbilitiesTechnologyButtonMessage message, final PlayPayloadContext context) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PowerMod.addNetworkMessage(WheelAbilitiesTechnologyButtonMessage.ID, WheelAbilitiesTechnologyButtonMessage::new, WheelAbilitiesTechnologyButtonMessage::handleData);
	}
}
