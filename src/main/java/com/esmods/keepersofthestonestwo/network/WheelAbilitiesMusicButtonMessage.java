...
public record WheelAbilitiesMusicButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static final ResourceLocation ID = new ResourceLocation(PowerMod.MODID, "wheel_abilities_music_buttons");
	...
	public static void handleData(final WheelAbilitiesMusicButtonMessage message, final PlayPayloadContext context) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PowerMod.addNetworkMessage(WheelAbilitiesMusicButtonMessage.ID, WheelAbilitiesMusicButtonMessage::new, WheelAbilitiesMusicButtonMessage::handleData);
	}
}
