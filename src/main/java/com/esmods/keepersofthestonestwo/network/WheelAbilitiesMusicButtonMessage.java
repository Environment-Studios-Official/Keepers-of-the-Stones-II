...
public class WheelAbilitiesMusicButtonMessage {
	private final int buttonID, x, y, z;

	public WheelAbilitiesMusicButtonMessage(FriendlyByteBuf buffer) {
	...
	public WheelAbilitiesMusicButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(WheelAbilitiesMusicButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(WheelAbilitiesMusicButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PowerMod.addNetworkMessage(WheelAbilitiesMusicButtonMessage.class, WheelAbilitiesMusicButtonMessage::buffer, WheelAbilitiesMusicButtonMessage::new, WheelAbilitiesMusicButtonMessage::handler);
	}
}
