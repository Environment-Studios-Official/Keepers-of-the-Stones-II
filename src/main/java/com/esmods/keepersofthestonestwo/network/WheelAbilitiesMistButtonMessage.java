...
public record WheelAbilitiesMistButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static final ResourceLocation ID = new ResourceLocation(PowerMod.MODID, "wheel_abilities_mist_buttons");
	...
	public static void handleData(final WheelAbilitiesMistButtonMessage message, final PlayPayloadContext context) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PowerMod.addNetworkMessage(WheelAbilitiesMistButtonMessage.ID, WheelAbilitiesMistButtonMessage::new, WheelAbilitiesMistButtonMessage::handleData);
	}
}
