...
public record WheelAbilitiesExplosionButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static final ResourceLocation ID = new ResourceLocation(PowerMod.MODID, "wheel_abilities_explosion_buttons");
	...
	public static void handleData(final WheelAbilitiesExplosionButtonMessage message, final PlayPayloadContext context) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PowerMod.addNetworkMessage(WheelAbilitiesExplosionButtonMessage.ID, WheelAbilitiesExplosionButtonMessage::new, WheelAbilitiesExplosionButtonMessage::handleData);
	}
}
