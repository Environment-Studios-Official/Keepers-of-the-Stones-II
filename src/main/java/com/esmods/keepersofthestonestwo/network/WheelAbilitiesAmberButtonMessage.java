...
public record WheelAbilitiesAmberButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static final ResourceLocation ID = new ResourceLocation(PowerMod.MODID, "wheel_abilities_amber_buttons");
	...
	public static void handleData(final WheelAbilitiesAmberButtonMessage message, final PlayPayloadContext context) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PowerMod.addNetworkMessage(WheelAbilitiesAmberButtonMessage.ID, WheelAbilitiesAmberButtonMessage::new, WheelAbilitiesAmberButtonMessage::handleData);
	}
}
