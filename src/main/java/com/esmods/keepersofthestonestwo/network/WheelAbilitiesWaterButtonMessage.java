...
public record WheelAbilitiesWaterButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static final ResourceLocation ID = new ResourceLocation(PowerMod.MODID, "wheel_abilities_water_buttons");
	...
	public static void handleData(final WheelAbilitiesWaterButtonMessage message, final PlayPayloadContext context) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PowerMod.addNetworkMessage(WheelAbilitiesWaterButtonMessage.ID, WheelAbilitiesWaterButtonMessage::new, WheelAbilitiesWaterButtonMessage::handleData);
	}
}
