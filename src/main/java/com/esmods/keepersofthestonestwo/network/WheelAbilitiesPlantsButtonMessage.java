...
public record WheelAbilitiesPlantsButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static void handleData(final WheelAbilitiesPlantsButtonMessage message, final PlayPayloadContext context) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PowerMod.addNetworkMessage(WheelAbilitiesPlantsButtonMessage.ID, WheelAbilitiesPlantsButtonMessage::new, WheelAbilitiesPlantsButtonMessage::handleData);
	}
}
