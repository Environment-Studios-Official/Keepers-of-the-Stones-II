...
public class MusicSpecialAttackProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		double playerPosZ = 0;
		double playerPosX = 0;
		if ((entity.getData(PowerModVariables.PLAYER_VARIABLES).ability).equals("music_attack_1")) {
		...
		} else if ((entity.getData(PowerModVariables.PLAYER_VARIABLES).ability).equals("music_attack_2")) {
		...
		} else if ((entity.getData(PowerModVariables.PLAYER_VARIABLES).ability).equals("music_attack_3")) {
