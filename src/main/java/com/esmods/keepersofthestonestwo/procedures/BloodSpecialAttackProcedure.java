...
public class BloodSpecialAttackProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		double Scaling = 0;
		if ((entity.getData(PowerModVariables.PLAYER_VARIABLES).ability).equals("blood_attack_1")) {
			if (entity.getData(PowerModVariables.PLAYER_VARIABLES).power >= 15) {
				...
				if (world instanceof Level _level) {
					if (!_level.isClientSide()) {
						_level.playSound(null, BlockPos.containing(x, y, z), BuiltInRegistries.SOUND_EVENT.get(new ResourceLocation("item.honeycomb.wax_on")), SoundSource.NEUTRAL, 1, 1);
					} else {
						_level.playLocalSound(x, y, z, BuiltInRegistries.SOUND_EVENT.get(new ResourceLocation("item.honeycomb.wax_on")), SoundSource.NEUTRAL, 1, 1, false);
					}
				}
				{
		...
		} else if ((entity.getData(PowerModVariables.PLAYER_VARIABLES).ability).equals("blood_attack_2")) {
		...
		} else if ((entity.getData(PowerModVariables.PLAYER_VARIABLES).ability).equals("blood_attack_3")) {
			if (entity.getData(PowerModVariables.PLAYER_VARIABLES).power >= 40) {
